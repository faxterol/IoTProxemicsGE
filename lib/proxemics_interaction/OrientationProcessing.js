...
module.exports = function(entity) {
    ...
    if(typeof entity.last_notification.orientation_degrees != "undefined"){
        ...
        entity.proxemics_data.orientation_degress = parseInt(entity.last_notification.orientation_degrees.value);
    }
    ...
    entities_query.then(function(entities){
        _.each(entities,function(value){
            ...
            console.log("Entity "+entity.entity_id+" ("+entity.proxemics_data.orientation_degress+") is in "+e.proxemics_data.location_id+"("+e.proxemics_data.orientation_degress+")");
            
            if(typeof entity.proxemics_data.orientation_degress != "undefined" && typeof e.proxemics_data.orientation_degress != "undefined"){
                var angle = sv(entity.proxemics_data.orientation_degress,e.proxemics_data.orientation_degress);
